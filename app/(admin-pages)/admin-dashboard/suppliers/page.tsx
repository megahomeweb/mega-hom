...
const SuppliersPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <h1 className="text-xl font-bold text-pink-500 mb-4">Yetkazib beruvchilar</h1>

      <div className="bg-pink-50 border border-pink-100 rounded-xl p-4 mb-5 grid sm:grid-cols-3 gap-3">
        ...
        <button
          onClick={add}
          disabled={busy}
          className="sm:col-span-3 px-4 py-2.5 rounded-lg bg-pink-500 text-white font-bold hover:bg-pink-600 disabled:opacity-50"
        >
          ...
          {suppliers.map((s) => (
            <div key={s.id} className="border border-slate-200 rounded-xl p-4 flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                {s.phone && (
                  <a href={`tel:${s.phone}`} className="text-sm text-pink-600 inline-flex items-center gap-1 mt-0.5">
