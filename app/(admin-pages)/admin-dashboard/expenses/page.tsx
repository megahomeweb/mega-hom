...
const ExpensesPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <h1 className="text-xl font-bold text-pink-500 mb-4">Xarajatlar</h1>

      {/* Yangi xarajat */}
      <div className="bg-pink-50 border border-pink-100 rounded-xl p-4 mb-5 grid sm:grid-cols-2 gap-3">
        ...
        <button
          onClick={add}
          disabled={busy}
          className="sm:col-span-2 px-4 py-2.5 rounded-lg bg-pink-500 text-white font-bold hover:bg-pink-600 disabled:opacity-50"
        >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
        ...
        <p className="text-sm text-slate-600">
          Jami: <b className="text-pink-600">{FormattedPrice(total)} UZS</b>
        </p>
      </div>
